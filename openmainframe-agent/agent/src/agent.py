"""
LangGraph agent definition — full graph with all capability nodes.
...
Batch 8: assess node — completes all 6 capability nodes.
"""
...
# Add nodes — router + 6 capability nodes + shared tool executor
...
# Router dispatches via Command to all capability nodes
