...
///
/// Used to distinguish tokens from different files (main source vs copybooks).
...
///
/// Spans are used throughout the compiler to track where each token and
/// AST node originated in the source. This enables:
