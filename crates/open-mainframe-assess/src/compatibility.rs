...
pub fn get_feature_support() -> Vec<FeatureSupport> {
    vec![
        FeatureSupport {
            ...
            supported: true,
            support_level: 100,
            notes: "Full support via open-mainframe-dataset".to_string(),
        },
        FeatureSupport {
            feature: "VSAM KSDS".to_string(),
            supported: true,
            support_level: 90,
            notes: "Emulated via open-mainframe-dataset VSAM module".to_string(),
        },
        FeatureSupport {
        ...
        FeatureSupport {
            ...
            supported: true,
            support_level: 85,
            notes: "Translated to PostgreSQL via open-mainframe-db2".to_string(),
        },
        FeatureSupport {
            feature: "CICS Commands".to_string(),
            supported: true,
            support_level: 75,
            notes: "Core commands supported via open-mainframe-cics".to_string(),
        },
        FeatureSupport {
            feature: "BMS Maps".to_string(),
            supported: true,
            support_level: 70,
            notes: "Basic BMS support via open-mainframe-cics bms module".to_string(),
        },
        FeatureSupport {
        ...
        FeatureSupport {
            ...
            supported: true,
            support_level: 80,
            notes: "Core JCL supported via open-mainframe-jcl".to_string(),
        },
        FeatureSupport {
            feature: "SORT Utility".to_string(),
            supported: true,
            support_level: 90,
            notes: "Full SORT support via open-mainframe-sort".to_string(),
        },
    ]
}
