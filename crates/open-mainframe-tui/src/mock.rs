...
impl MockTerminal {
    ...
    pub fn new() -> Self {
        Self {
            ...
            default_aid: open_mainframe_cics::runtime::eib::aid::ENTER,
        }
    }
    ...
    pub fn queue_enter(&mut self) {
        self.queue_input(open_mainframe_cics::runtime::eib::aid::ENTER, HashMap::new());
    }

    /// Queue a PF3 key press.
    pub fn queue_pf3(&mut self) {
        self.queue_input(open_mainframe_cics::runtime::eib::aid::PF3, HashMap::new());
    }
...
mod tests {
    ...
    fn test_queue_and_receive_input() {
        ...
        let map = open_mainframe_cics::bms::BmsMap {
            name: "TEST".to_string(),
            size: (24, 80),
            fields: Vec::new(),
            ..Default::default()
